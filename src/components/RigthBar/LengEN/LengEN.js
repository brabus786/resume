...
const LengEN = () => {
    return (
        <div>
            ...
            <p>
                <b> Frontend Developer on the Tattz project for masters and tattoo studios.</b>
            </p>
            <p>
            ...
            <p>
                I developed the project from using technologies like: React, Next.js, Redux, React Hook Forms, Google Maps API.
            </p>
            ...
            <p>
                <b>Frontend Developer of e-commerce projects Tesla Weld and Tatra Garden</b>
            </p>

            <p>
                My main responsibilities were frontend development based on CMS Opencart of the main websites. Also I was developing sites
                for launching advertising campaigns, animated interfaces and interactive blocks on the
